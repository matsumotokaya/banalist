...
export const AuthButton = () => {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-2 md:px-4 py-2 text-sm font-medium text-white bg-black border border-white/20 rounded-lg hover:bg-white hover:text-black transition-colors"
